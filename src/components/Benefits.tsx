...
const benefits = [
  ...
  {
    icon: <VisibilityOutlinedIcon sx={{ fontSize: 28, color: '#7C3AED' }} />,
    iconBg: 'transparent',
    title: 'Total Transparencia',
    description: 'Rastrea cada campana, pago y entregable con total auditabilidad.',
  },
  {
    ...
    description:
      'Flujos de aprobacion aseguran que solo influencers verificados lleguen a tus campanas.',
  },
];
            ...
            >
              <Box
                sx={{
                  ...
                  height: 52,
                  borderRadius: '14px',
                  backgroundColor: benefit.iconBg || '#F5F3FF',
                  display: 'flex',
                  alignItems: 'center',
